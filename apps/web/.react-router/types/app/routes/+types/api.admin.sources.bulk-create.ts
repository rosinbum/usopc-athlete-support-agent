...
type Module = typeof import("../api.admin.sources.bulk-create.js")

type Info = GetInfo<{
  file: "routes/api.admin.sources.bulk-create.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.admin.sources.bulk-create.js");
}];
