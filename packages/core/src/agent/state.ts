...
export const AgentStateAnnotation = Annotation.Root({
  ...
  /**
   * Rolling conversation summary generated by Haiku.
   * Preserves key entities, emotional state, and discussion topics
   * across long conversations without bloating the prompt.
   */
