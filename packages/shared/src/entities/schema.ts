...
export const AppTableSchema = {
  ...
  models: {
    ...
    AccessRequest: {
      pk: { type: String, value: "AccessReq#${email}" },
      sk: { type: String, value: "AccessRequest" },
      gsi1pk: { type: String, value: "AccessReq#${status}" },
      gsi1sk: { type: String, value: "${requestedAt}" },
      email: { type: String, required: true },
      name: { type: String, required: true },
      sport: { type: String },
      role: { type: String },
    ...
    Feedback: {
      pk: { type: String, value: "Feedback#${id}" },
      sk: { type: String, value: "Feedback" },
      gsi1pk: { type: String, value: "Feedback#${conversationId}" },
      gsi1sk: { type: String, value: "${createdAt}" },
      id: { type: String, required: true },
